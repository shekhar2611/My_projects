    ...
    public class SchoolHandler : IHttpHandler, IRequiresSessionState
    {
        ...
        private void Leave_message(HttpContext context)
        {
            try
            {
                ...
                Msg.Body += "<div style='width: 100%; min-height: 20px; padding: 10px; margin: 0 auto; background-color: #fff;font-family: Arial,Helvetica,sans-serif; font-size: 12px;line-height:20px;overflow:auto'><p> <div style='font-size: 35px; text-align: center;color:white; margin-bottom: 25px; font-weight: 300;background-color: #a02503;line-height: 150%'> <a><b style='color:white;'><img src='http://www.apnabazaarpdx.com/img/logo.jpg' style='height:70px;width:200px;' /></b></a></div> Hello,iam " + name + "<br /><br /> " + message + "<br /><br />Contact me at " + emailid + "</p></div><footer> <div style='width: 100%; min-height: 20px; padding: 3px; margin: 0 auto; background-color: #555;font-family: Arial,Helvetica,sans-serif; font-size: 12px;line-height:20px;'> <center> <p style='color:White;'>Visit:  ApnaBazaarpdx.com </p></center></div></footer>";
